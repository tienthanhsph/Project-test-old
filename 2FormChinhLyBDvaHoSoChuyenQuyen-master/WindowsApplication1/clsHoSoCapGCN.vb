Public Class clsHoSoCapGCN
    ...
    Private strtunam As String = ""
    Private strdennam As String = ""
    ...
    Private strSoQuyetDinh As String = ""
    Public Property SoQuyetDinh() As String
        Get
            Return strSoQuyetDinh
        End Get
        Set(ByVal value As String)
            strSoQuyetDinh = value
        End Set
    End Property
    ...
    Public Property TuNam() As String
        Get
            Return strtunam
        End Get
        Set(ByVal value As String)
    ...
    Public Property DenNam() As String
        Get
            Return strdennam
        End Get
        Set(ByVal value As String)
...
#End Region
    ...
    Private Function Execute(ByRef strRecords As String, ByVal strStoreProcedureName As String) As String
        Try
            ...
            Database.Connection = "Data Source=DMC-PC\SQL2005;Initial Catalog=georgetown_ThanhTri ;User ID=sa ;PassWord=dmc3star;"
    ...
    Public Function ActiveChucNang(ByVal intMangChucNang As Int32(), ByVal strTenChucNang As String) As Boolean
        ...
        Return boolTemp
    End Function
    Public Function InsertLichSuBienDongThuaDat()
        Return Me.ExecuteLichSuBienDongThuaDat("spCapNhapThuaDatBienDongTaoHoSoCapGCN")
    End Function

    Private Function ExecuteLichSuBienDongThuaDat(ByVal strStoreProcedureName As String) As String
        Try
            'Khởi tạo giá trị cho biến nhận thông báo lỗi
            strError = ""
            ...
            If Database.OpenConnection = True Then
                'Khai bao mang gia tri
                Dim Paras() As String = {"@MaThuaDat", "@MaHoSoCapGCN", "@DVHC", "@ToBanDo", "@SoThua", "@DienTichTuNhien"}
                Dim Values() As String = {strMaThuaDat, strMaHoSoCapGCN, strMaDonViHanhChinh, strToBanDo, strSoThua, dblDienTichTuNhien}
                'Chắc chắn rằng mảng giá trị truyền vào tương đương với mảng tham biến
                If (Paras.Length <> Values.Length) Then
                    Return "Mảng giá trị chuyền vào chưa phù hợp!"
                End If
    ...
    End Function
    Public Function SelectHoSoBySoPhatHanhGCN(ByRef dtRecords As DataTable) As String
        Dim Paras() As String = {"@flag", "@TuSoPhatHanh", "@DenSoPhatHanh", "@TuNam", "@ToiNam", "@MaDVHC"} ', "@HinhDangThua"}
        Dim Values() As String = {0, strTuSoPhatHanh, strDenSoPhatHanh, strtunam, strdennam, strMaDonViHanhChinh}
        Return Me.SelectData("spSelectHoSoBySoPhatHanhGCN", dtRecords, Paras, Values)
    End Function
    Public Function SelectHoSoBySoChuyenQuyen(ByRef dtRecords As DataTable) As String
        Dim Paras() As String = {"@Thang", "@Nam", "@MaDVHC"}
        Dim Values() As String = {strThang, strNam, strMaDonViHanhChinh}
        Return Me.SelectData("spSelectHoSoChuyenQuyen", dtRecords, Paras, Values)
    End Function
    Public Function SelectChinhLyBienDong(ByRef dtRecords As DataTable) As String
        Dim Paras() As String = {"@TuNgay", "@DenNgay", "@SoQuyetDinh", "@MaDVHC"}
        Dim Values() As String = {strTuNgay, strDenNgay, strSoQuyetDinh, strMaDonViHanhChinh}
        Return Me.SelectData("SelectChinhLyBienDongDatDai", dtRecords, Paras, Values)
    End Function
    Public Sub XoaHoSoRac(ByVal vTenThuTuc As String)
        Try
            Dim Database As New clsDatabase
            Database.Connection = "Data Source=DMC-PC\SQL2005;Initial Catalog=georgetown_ThanhTri ;User ID=sa ;PassWord=dmc3star;"
            If Database.OpenConnection = True Then
                ...
                Database.ExecuteSP(vTenThuTuc, vParas, vValues, "")
                Database.CloseConnection()
            End If
        Catch ex As Exception
            strError = ex.Message
