...
{
    public partial class frmXemLichSuBienDong : Form
    {
        public frmXemLichSuBienDong()
        {
            InitializeComponent();
        }
        ...
        private void frmXemLichSuBienDong_Load(object sender, EventArgs e)
        {
            ReLoad();
        }
        ...
        {
            int kq = 0;
            string query = " select MaHoSo from tblDangKyBienDongDatNN Where MaHoSoMoi =" + _MaHoSo.ToString();
            try
            {
        ...
        {
            int kq = 0;
            string query = " select MaHoSoMoi from tblDangKyBienDongDatNN Where MaHoSoMoi is not null and MaHoSo =" + _MaHoSo.ToString();
            try
            {
                kq = Convert.ToInt32(cls.ExecuteQueryScalar(query));
            }
