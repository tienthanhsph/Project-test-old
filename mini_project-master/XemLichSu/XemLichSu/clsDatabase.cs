...
namespace XemLichSu
{
    class clsDatabase
    {
        ...
        public void OpenCon()
        {
            ...
            sqlcon.ConnectionString = "server = TIENTHANH-PC\\SQLEXPRESS; Database = XemLichSu; User= sa; Password = Thanhid1";
            try
            {
        ...
        public string[] GetList(string query, string OutputColumn)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Lỗi ExecuteReader");
            }
            CloseCon();
            //if (result.Count == 0)
            //    result.Add("");
