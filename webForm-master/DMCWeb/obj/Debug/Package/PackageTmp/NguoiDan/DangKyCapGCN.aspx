<%@ Page Title="" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="DangKyCapGCN.aspx.cs" Inherits="DMCWeb.NguoiDan.DangKyCapGCN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="tieude-xanh">
        ĐƠN ĐĂNG KÝ CẤP GCN QUYỀN SỬ DỤNG ĐẤT
    </div>
    <div class="btn-group">
            ...
            <WizardSteps>
                ...
                <asp:WizardStep ID="stepGuiHoSo" runat="server" Title="THÔNG TIN GỬI HỒ SƠ">
                    <div class="blogthongtin" id="thongtinhoso">
                        <div class="tieudeblogthongtin">THÔNG TIN GỬI/NHẬN HỒ SƠ</div>
                         <div class="nhapthongtin">
    ...
    <div class="center" id="ChapNhan">
        <asp:Button CssClass="btn btn-lg btn-danger" ID="btnChapNhan" runat="server" Text="Chấp nhận hồ sơ." OnClick="btnChapNhan_Click" />
    </div>
    </div>
</asp:Content>
