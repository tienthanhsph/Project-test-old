<%@ Page Title="" Language="C#" MasterPageFile="~/Excute.Master" AutoEventWireup="true" CodeBehind="TimKiemHoSoBienDong.aspx.cs" Inherits="DMCWeb.VanPhong.TimKiemHoSoBienDong" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--<div class="center">
       ...
       <br />
        ...
        <div class="center"> 
            <asp:Button CssClass="btn btn-lg btn-default" ID="btnTimKiemBienDong" runat="server" Text="Tìm kiếm" OnClick="btnTim_Click" />
        </div>
    </div>
        ...
        <asp:GridView CssClass="center" ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="MaDangKyBienDong" DataTextField="MaDangKyBienDong" HeaderText="Biến động" DataNavigateUrlFormatString="~/NguoiDan/DangKyBienDong/DonDangKyBienDong.aspx?DangKyBienDong={0}&LoaiHoSo=ChinhThuc" />
